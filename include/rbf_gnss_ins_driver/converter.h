...
namespace rbf_gnss_ins_driver
{
    ...
    public:
        ...
        rbf_gnss_ins_driver::msg::ImuStatus raw_imu_to_imu_status(const RawImu& raw_imu, std::string frame_id); 

        // Function to convert raw heading data to ROS message
        rbf_gnss_ins_driver::msg::Heading heading_to_msg(const UniHeading& heading, std::string frame_id);
        ...
        rbf_gnss_ins_driver::msg::GnssVel gnss_vel_to_msg(const BestGnssVel& gnss_vel, std::string frame_id);

        // Function to convert raw gnss position data to ROS message
        rbf_gnss_ins_driver::msg::GnssStatus gnss_pos_to_gnss_status_msg(const BestGnssPos& gnss_pos, std::string frame_id);
