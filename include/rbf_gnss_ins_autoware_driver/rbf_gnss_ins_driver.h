...
#include <rbf_gnss_ins_autoware_driver/msg/rtcm_status.hpp>
...
namespace rbf_gnss_ins_autoware_driver
{
    ...
    private:
        ...
        /*CUSTOM PUBLISHERS*/
        rclcpp::Publisher<rbf_gnss_ins_autoware_driver::msg::Ins>::SharedPtr pub_ins_;
        rclcpp::Publisher<rbf_gnss_ins_autoware_driver::msg::Heading>::SharedPtr pub_heading_;
        rclcpp::Publisher<rbf_gnss_ins_autoware_driver::msg::ECEF>::SharedPtr pub_ecef_;
        rclcpp::Publisher<rbf_gnss_ins_autoware_driver::msg::ImuStatus>::SharedPtr pub_imu_status_;
        rclcpp::Publisher<rbf_gnss_ins_autoware_driver::msg::GnssVel>::SharedPtr pub_gnss_vel_;
        rclcpp::Publisher<rbf_gnss_ins_autoware_driver::msg::GnssStatus>::SharedPtr pub_gnss_status_;
        rclcpp::Publisher<rbf_gnss_ins_autoware_driver::msg::RTCMStatus>::SharedPtr pub_rtcm_status_;
