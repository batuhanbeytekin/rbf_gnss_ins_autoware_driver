...
namespace rbf_gnss_ins_driver{
    ...
    sensor_msgs::msg::Imu Converter::raw_imu_to_imu_msg(const RawImu& raw_imu, std::string frame_id) {
        ...
        imu_msg.angular_velocity.x = degree_to_radian(raw_gyro_to_deg_s(raw_imu.x_gyro_output));
        imu_msg.angular_velocity.y = -1.0 * degree_to_radian(raw_gyro_to_deg_s(raw_imu.y_gyro_output));
        imu_msg.angular_velocity.z = degree_to_radian(raw_gyro_to_deg_s(raw_imu.z_gyro_output));
